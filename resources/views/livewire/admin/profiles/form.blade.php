    ...
    <div class="flex flex-wrap items-start justify-between gap-4">
        <div>
            ...
            <p class="mt-3 text-zinc-400">
                {{ $profile ? 'Atualize os dados do perfil do catálogo.' : 'Crie um novo perfil para o catálogo do AutoM8.' }}
            </p>
        </div>
    ...
    <form wire:submit="save" class="rounded-2xl border border-zinc-800 bg-zinc-900 p-6">
        <div class="grid gap-6">
            ...
            <div class="flex items-center gap-3">
                ...
                <label for="is_active" class="text-sm text-zinc-300">Perfil ativo</label>
            </div>
        </div>
